...
\code{dmat}\footnote{Retired from pmclust}
assumes \code{X.std} is a \code{ddmatrix}.
See \pkg{pbdDEMO}~\citep{Schmidt2013pbdDEMOpackage} and it's
vignette~\citep{Schmidt2013pbdDEMOvignette}
for more details of \code{gbdr} and
\code{ddmatrix}\footnote{Retired from pmclust}.
