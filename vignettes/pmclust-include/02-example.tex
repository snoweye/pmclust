...
Further, \code{X.spmd} may be replaced by
\code{X.dmat}\footnote{Retired from pmclust} in a \code{ddmatrix}
...
Table~\ref{tab:dmat}\footnote{Retired from pmclust}.
The details of block-cyclic (\code{X.dmat}) can be found
in the pbdR
